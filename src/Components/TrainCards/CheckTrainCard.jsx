...
export default function CheckTrainCard({route}) {
    ...
    return <div className={style.trainCard} style={{marginTop : 0}}>
        ...
        <div className={style.trainPrice}>
            <div className={style.categoriPlaces}>
               ...
               {route?.available_seats_info?.second && <div className={style.categoriPlace}>
                ...
                <button className={style.selectPlace} style={{backgroundColor: 'transparent', color: 'black', border: 'solid 2px black', borderRadius: '8px'}} onClick={handleClick}>Изменить</button>
            </div>
        </div>
    </div >
}
