    ...
    return <div className={style.vanType}>
        ...
        <div className={style.vanTypeContainer}>
            <div className={style.vanTypeItem}>
                <Sit style={{height: '50px', width: '50px'}} fill={type === '' ? '#FFA800' : '#E5E5E5'}/>
                <p style={{color: type === '' ? '#FFA800' : 'black'}}>Сидячий</p>
            </div>
            <div className={style.vanTypeItem}>
                <ReservedSeat style={{height: '50px', width: '50px'}} fill={type === '' ? '#FFA800' : '#E5E5E5'}/>
                <p style={{color: type === '' ? '#FFA800' : 'black'}}>Плацкарт</p>
            </div>
            <div className={style.vanTypeItem}>
                <Compartment style={{height: '50px', width: '50px'}} fill={type === '' ? '#FFA800' : '#E5E5E5'}/>
                <p style={{color: type === '' ? '#FFA800' : 'black'}}>Купе</p>
            </div>
            <div className={style.vanTypeItem}>
